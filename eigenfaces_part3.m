...
liste_personnes_base = {'m01', 'm02', 'm03', 'm04', 'm05', 'm06', 'm07', 'm08'}
...
% SUBSPACE ITERATION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% utilisation de subspace_iter_v2 de la partie 2:
m = 16;
eps = 10^(-3);
maxit = 100;
[V_2, D] = subspace_iter_v2(Sigma2,m,.1,10,eps,100);

% utilisation de subspace iteration 
%[vap, V_2, it, D ] = subspace_iter_v0( Sigma2, m, eps, maxit);
...
% Calcul de l'individu moyen :
% Dimensions du masque (elles proviennent de la version précédente du code
% sur moodle)
ligne_min = 200;
ligne_max = 350;
colonne_min = 60;
...
for j = 1:nb_personnes_base,
	...
	for k = liste_postures_base,
        ...
        liste_base = [liste_base ; ficF];
        img = imread(ficF);
         % Degradation de l'image: pour apparition du masque 
...
% utilisation de subspace iteration 
%[vap, V_2, it, flag ] = subspace_iter_v0( Sigma2, m, eps, maxit);
% Les vecteurs propres de Sigma (les eigenfaces) se deduisent de ceux de Sigma2 :
...
%% Sauvegarde des variables nécessaires pour la suite
save('eigenfaces_part3.mat', 'individu_moyen', 'lambda', 'W','W_masque','X_centre_masque', 'X_centre', 'nb_personnes', 'nb_postures', 'nb_personnes_base', 'nb_postures_base', ...
    'liste_personnes_base', 'liste_personnes', 'liste_postures', 'L', 'H', 'liste_base');
